      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-6 md:grid-cols-[1.4fr_1fr_1fr]">
        ...
        <div>
          <a href="#" className="flex items-center gap-2">
            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-brand text-lg font-extrabold text-white">
              B
            </span>
          ...
          <div className="mt-5 flex gap-3">
            ...
            <a
              ...
              className="flex h-9 w-9 items-center justify-center rounded-xl bg-white text-ink-muted shadow-soft transition hover:text-brand"
              aria-label="WhatsApp"
            >
        ...
        {/* Links */}
        <div>
          <p className="text-sm font-bold text-ink">Navigasi</p>
